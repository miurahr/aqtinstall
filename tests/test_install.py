...
def test_install_qt6_wasm_autodesktop(monkeypatch, capsys, version, str_version, wasm_arch):
    ...
    wasm_archives = [
        ...
        MockArchive(
            filename_7z="qtsvg-Windows-Windows_10_22H2-Clang-Windows-WebAssembly-X86_64.7z",
            update_xml_name=f"qt.qt6.{str_version}.{wasm_arch}.qtsvg",
            version=version,
            arch_dir=wasm_arch,
            contents=(),
        ),
        MockArchive(
            filename_7z="qtdeclarative-Windows-Windows_10_22H2-Clang-Windows-WebAssembly-X86_64.7z",
            update_xml_name=f"qt.qt6.{str_version}.{wasm_arch}.qtdeclarative",
            version=version,
            arch_dir=wasm_arch,
            contents=(),
        ),
        MockArchive(
            filename_7z="qttools-Windows-Windows_10_22H2-Clang-Windows-WebAssembly-X86_64.7z",
            update_xml_name=f"qt.qt6.{str_version}.{wasm_arch}.qttools",
            version=version,
            arch_dir=wasm_arch,
            contents=(),
        ),
        MockArchive(
            filename_7z="qttranslations-Windows-Windows_10_22H2-Clang-Windows-WebAssembly-X86_64.7z",
            update_xml_name=f"qt.qt6.{str_version}.{wasm_arch}.qttranslations",
            version=version,
            arch_dir=wasm_arch,
            contents=(),
        ),
        MockArchive(
            filename_7z="qtshadertools-Windows-Windows_10_22H2-Clang-Windows-WebAssembly-X86_64.7z",
            update_xml_name=f"qt.qt6.{str_version}.{wasm_arch}.qtshadertools",
            version=version,
            arch_dir=wasm_arch,
            contents=(),
        ),
        MockArchive(
            filename_7z="icu-Windows-Windows_10_22H2-Clang-Windows-WebAssembly-X86_64.7z",
            update_xml_name=f"qt.qt6.{str_version}.{wasm_arch}.qticu",
            version=version,
            arch_dir=wasm_arch,
            contents=(),
        ),
    ...
    desk_archives_by_host = {
        "linux": (
            [
                ...
                MockArchive(
                    filename_7z="qtsvg-linux-gcc_64.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qtsvg.gcc_64",
                    version=version,
                    arch_dir="gcc_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qtdeclarative-linux-gcc_64.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qtdeclarative.gcc_64",
                    version=version,
                    arch_dir="gcc_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qttools-linux-gcc_64.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qttools.gcc_64",
                    version=version,
                    arch_dir="gcc_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qttranslations-linux-gcc_64.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qttranslations.gcc_64",
                    version=version,
                    arch_dir="gcc_64",
                    contents=(),
                ),
        ...
        "darwin": (
            [
                ...
                MockArchive(
                    filename_7z="qtsvg-mac-clang_64.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qtsvg.clang_64",
                    version=version,
                    arch_dir="clang_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qtdeclarative-mac-clang_64.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qtdeclarative.clang_64",
                    version=version,
                    arch_dir="clang_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qttools-mac-clang_64.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qttools.clang_64",
                    version=version,
                    arch_dir="clang_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qttranslations-mac-clang_64.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qttranslations.clang_64",
                    version=version,
                    arch_dir="clang_64",
                    contents=(),
                ),
        ...
        "win32": (
            [
                ...
                MockArchive(
                    filename_7z="qtsvg-windows-win64_mingw.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qtsvg.win64_mingw",
                    version=version,
                    arch_dir="mingw_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qtdeclarative-windows-win64_mingw.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qtdeclarative.win64_mingw",
                    version=version,
                    arch_dir="mingw_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qttools-windows-win64_mingw.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qttools.win64_mingw",
                    version=version,
                    arch_dir="mingw_64",
                    contents=(),
                ),
                MockArchive(
                    filename_7z="qttranslations-windows-win64_mingw.7z",
                    update_xml_name=f"qt.qt6.{str_version}.qttranslations.win64_mingw",
                    version=version,
                    arch_dir="mingw_64",
                    contents=(),
                ),
