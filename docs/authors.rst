...
* Alexandre @Kidev Poumaroux (official installer option, WASM fixes for Qt6.7.x, manuals and many)
* Andrew Wason (support arm64)
* Andrei Yankovich (tools ifw installation)
* Arnaud de Mouhy (mac arm64 official installer case)
...
* @tsteven4 (fix patching, support for Qt 6.8.x, windows_arm64, and many)
* @xavier2k6 (improve ci/cd and tests)
